<script lang="ts">
  ...
  export let loadingMissingCards: boolean = false;
        ...
        <div class="flex flex-col gap-2">
          ...
          <div>
            <label class="flex items-center">
              <input
                ...
                disabled={fetchingAllSets || isLoadingCurrentSet || loadingMissingCards}
              />
              <span class="ml-2 text-sm text-gray-700">Show missing cards</span>
              {#if loadingMissingCards && showMissingCards}
                ...
                <span class="ml-1 text-xs text-indigo-600">Loading missing cards...</span>
              {:else if fetchingAllSets || isLoadingCurrentSet}
                <svg class="ml-2 w-4 h-4 animate-spin text-indigo-600" fill="none" viewBox="0 0 24 24">
                  <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                  <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                </svg>
          ...
          <div>
            <label class="flex items-center">
              ...
              {#if loadingMissingCards && onlyMissingCards}
                <svg class="ml-2 w-4 h-4 animate-spin text-indigo-600" fill="none" viewBox="0 0 24 24">
                  <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                  <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                </svg>
