...
{#if errorMessage && visible}
  <div class="{styles.bg} border {styles.border} rounded-lg p-4 mb-4">
    <div class="flex">
      ...
      {#if dismissible}
        <div class="ml-auto pl-3">
          <button
            type="button"
            on:click={dismiss}
            class="-mx-1.5 -my-1.5 {styles.bg} inline-flex rounded-md p-1.5 {styles.text} hover:bg-opacity-75 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-red-50 focus:ring-red-600"
          >
